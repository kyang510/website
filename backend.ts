...
function createRepoCard(repo: GitHubRepo): HTMLDivElement {
...
function createExternalLink(href: string | null, label: string): HTMLAnchorElement | null {
...
function parseHttpUrl(href: string | null): URL | null {
  if (!href) return null;
